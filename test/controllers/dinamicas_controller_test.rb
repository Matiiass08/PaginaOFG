...
class DinamicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinamica" do
    assert_difference("Dinamica.count") do
      post dinamicas_url, params: { dinamica: { descripcion: @dinamica.descripcion, nombre: @dinamica.nombre } }
    end
  ...
  test "should update dinamica" do
    patch dinamica_url(@dinamica), params: { dinamica: { descripcion: @dinamica.descripcion, nombre: @dinamica.nombre } }
